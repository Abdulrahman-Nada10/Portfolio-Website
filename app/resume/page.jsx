...
const about ={
  ...
  info:[
    {
      fieldName: "Name",
      fieldValue: "Abdulrhman-Nada",
    },
    {
      fieldName: "Phone",
      fieldValue: "01060573567",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "abdulrahmannada10@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  icon: '',
  title: "My Experience",
  description: "I have 1+ years of experience in web development, with a strong focus",
  items:[
    {
      company:'Arabian Systems Academy ',
      position:'Instructor',
      duration: '2024',
    }
  ]
...
const education = {
  icon: '',
  title: "My Education",
  description: "Faculty of Computers and Information Systems – HICMIS",
  items:[
    {
      institution:'NTI',
      degree:'Web Design Track',
      duration: '2023',
    },
    {
      institution:'ITI',
