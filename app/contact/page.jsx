...
const info = [
  {
    icon:<FaPhoneAlt/>,
    title: "Phone",
    description: "01155135780"
  },
  {
    icon:<FaEnvelope/>,
    title: "Email",
    description: "arabiansystemsacademy@gmail.com"
  },
  {
    icon:<FaMapMarkedAlt/>,
    title: "Address",
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value='Moblie-Application'>Moblie Application</SelectItem>
                    <SelectItem value='Full-Stack'>Full Stack</SelectItem>
                    <SelectItem value='Mentorship-Service'>Mentorship Service</SelectItem>
                    <SelectItem value='Programming-grant'>Programming grant</SelectItem>
                    <SelectItem value='Training-Service'>Training Service</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              <Textarea 
